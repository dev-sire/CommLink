...
const JoinPage = () => {
    ...
    return(
        <div className="h-full flex flex-col gap-y-8 items-center justify-center bg-white p-8 rounded-lg shadow-sm">
            <Image src="/logo.svg" alt="logo-Image" width={200} height={200} />
            <div className="flex flex-col gap-y-4 items-center justify-center max-w-md">
                ...
                <VerificationInput
                    ...
                    classNames={{
                        ...
                        character: "uppercase rounded-md h-auto border border-gray-300 flex items-center justify-center text-lg font-medium text-gray-500",
