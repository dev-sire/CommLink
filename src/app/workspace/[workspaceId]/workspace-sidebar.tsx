...
export const WorkspaceSidebar = () => {
    ...
    if(workspaceLoading || memberLoading || channelsLoading || membersLoading){
        return(
            <div className="flex flex-col bg-[#074799] h-full items-center justify-center">
    ...
    if(!workspace || !member){
        return(
            <div className="flex flex-col gap-y-2 bg-[#074799] h-full items-center justify-center">
    ...
    return(
        <div className="flex flex-col bg-[#074799] h-full">
